...
<template>
    ...
    <div class="min-h-screen bg-gray-50">
        <div
            class="bg-indigo-700 py-24 text-center text-white relative overflow-hidden"
        >
            <div class="relative z-10 px-4">
                ...
                <p
                    class="text-lg text-indigo-100 max-w-2xl mx-auto font-medium"
                >
            ...
            <div
                class="absolute -top-24 -right-24 w-96 h-96 bg-indigo-600 rounded-full blur-3xl opacity-50"
            ></div>
            <div
                class="absolute -bottom-24 -left-24 w-96 h-96 bg-blue-600 rounded-full blur-3xl opacity-30"
            ></div>
        </div>
                    ...
                    >
                        <div class="h-60 overflow-hidden relative">
                            <img
                                ...
                                :src="
                                    '/storage/' +
                                    auction.product.cover_image.image_path
                                "
                            ...
                            <div
                                class="absolute bottom-4 left-4 bg-black/60 backdrop-blur-md text-white text-[10px] px-4 py-2 rounded-full font-black tracking-widest"
                            >
                                02G : 14S : 45D
                            </div>
                        </div>
                        ...
                        <div class="p-7">
                            <div class="flex justify-between items-center mb-3">
                                <p
                                    class="text-[10px] text-indigo-600 font-black uppercase tracking-[0.15em]"
                                >
                                    {{
                                ...
                                <span
                                    class="bg-purple-100 text-purple-700 text-[9px] px-2 py-1 rounded-md font-black uppercase"
                                    >İHALE</span
                                >
                            </div>
                            <h4
                            ...
                            <p class="text-xs text-gray-400 mb-6 font-medium">
                                Satıcı:
                                {{
                                    auction.product.shop?.store_name ||
                                    "Mağaza Bilgisi Yok"
                                }}
                            </p>

                            <div
                                class="flex justify-between items-center border-t border-gray-50 pt-6"
                            >
                                <div>
                                    <p
                                        class="text-[10px] text-gray-400 uppercase font-black tracking-tighter mb-1"
                                    >
                                        En Yüksek Teklif
                                    </p>
                                    <p
                    ...
                    >
                        <div class="h-60 overflow-hidden relative">
                            <img
                                ...
                                :src="
                                    '/storage/' + product.cover_image.image_path
                                "
                                class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                            />
                            <div
                        ...
                        <div class="p-7">
                            <p
                                class="text-[10px] text-green-600 font-black uppercase tracking-[0.15em] mb-3"
                            >
                            ...
                            <p class="text-xs text-gray-400 mb-6 font-medium">
                                Mağaza:
                                {{ product.shop?.store_name || "Bilinmiyor" }}
                            </p>
